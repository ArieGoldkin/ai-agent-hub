...
// Re-export all types
export type { ClaudeConfig, MCPServerConfig, DetectedConfig } from "./types.js";
...
export { updateClaudeConfig, removeServersFromConfig } from "./updater.js";

// Re-export utility functions
export { backupConfig, validateClaudeConfig } from "./utils.js";
