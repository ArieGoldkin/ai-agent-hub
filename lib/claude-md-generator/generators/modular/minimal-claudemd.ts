...
export function generateMinimalClaudeMd(
  ...
  sections.push('| **brainstorming** | Transforming rough ideas into fully-formed designs (v3.6.0) |');
  ...
  sections.push('| **prototype-to-production** | Converting design prototypes to React/TypeScript components (v3.7.1) |');
