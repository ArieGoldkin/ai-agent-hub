...
# DEPENDENCY & CSS RULES

## Version Requirements

| Package | Version | Notes |
|---------|---------|-------|
| tailwindcss | ^3.4.0 | NEVER use v4 alpha |
| react | ^18.2.0 | Stable LTS |
| typescript | ^5.3.0 | Released stable |

**Rule**: No alpha, beta, rc, canary, or dev versions in production.

## Tailwind Quick Reference

| Pattern | ❌ Invalid | ✅ Valid |
|---------|-----------|---------|
| Heights | `min-h-44` | `min-h-[44px]` |
| Colors | `bg-blue-550` | `bg-blue-500` or `bg-[#hex]` |
| Scale | `scale-102` | `scale-105` or `scale-[1.02]` |

**Verification**: `npx tailwindcss --version` must show 3.x
